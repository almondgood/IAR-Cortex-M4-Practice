/*
PORT B PIN 7 Counter : dcmotor M_SENSOR
PORT B PIN 8 PWM : dcmotor M_EN
PORT B PIN 9 Motor direction : dcmotor M_D1
PORT B PIN 10 Motor direction : dcmotor M_D2
*/
...
void MOTOR_init()
{
  TIM10_init();         // portb pin 8 pwm
  TIM4_init();          // portb pin 7 counter
}
